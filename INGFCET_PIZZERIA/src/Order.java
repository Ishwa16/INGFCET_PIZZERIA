...
public class Order extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("     INGFCET PIZZERIA");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/ipizzeria_alt_logo.png"))); // NOI18N
    ...
    // THIS MAKES CONNECTION BETWEEN Net Beans AND MySQL      
       try
       {
         ...
         con=DriverManager.getConnection("jdbc:mysql://localhost/peperonipizzeria","root","");
